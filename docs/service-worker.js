const CACHE='alexandria-v6';
const SHELL=['./','./index.html','./data.json','./manifest.webmanifest','./assets/styles.css','./assets/chapters.css','./assets/app.js','./assets/chapters-v2.js','./assets/theme-bootstrap.js','./icons/alexandria-mark.svg','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
